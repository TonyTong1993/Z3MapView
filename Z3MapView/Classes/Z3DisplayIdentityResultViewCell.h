...
- (void)setIdentityResult:(Z3MapViewIdentityResult *)result indexPath:(NSIndexPath *)indexPath displayType:(NSInteger)displayType datasourceCount:(NSInteger)totalCount;
//隐藏底部按钮
