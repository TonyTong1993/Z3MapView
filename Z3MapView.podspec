...
Pod::Spec.new do |s|
  s.name             = 'Z3MapView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Z3MapView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Tony Tony/Z3MapView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Tony Tony' => 'tongwanhua1993@163.com' }
  s.source           = { :git => 'https://github.com/Tony Tony/Z3MapView.git', :tag => s.version.to_s }
